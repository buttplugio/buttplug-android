...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtplugServer bpServer = new ButtplugServer("Buttplug WebsocketServerGUI", 2000);
        bpServer.addDeviceSubtypeManager(new AndroidBluetoothManager(this, new ButtplugLogManager()));
    }
