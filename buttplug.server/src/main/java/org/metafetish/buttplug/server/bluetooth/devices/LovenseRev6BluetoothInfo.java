...
public class LovenseRev6BluetoothInfo implements IBluetoothDeviceInfo {
    public enum Chrs {
        Tx,
        Rx
    }
    ...
    private List<UUID> services = new ArrayList<UUID>() {{
        add(UUID.fromString("50300001-0023-4bd4-bbd5-a6920e4c5653"));
    }};
    ...
    private List<UUID> characteristics = new ArrayList<UUID>() {{
        // tx
        add(UUID.fromString("50300002-0023-4bd4-bbd5-a6920e4c5653"));
        // rx
        add(UUID.fromString("50300003-0023-4bd4-bbd5-a6920e4c5653"));
    }};
